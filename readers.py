...
class Reader():
    ...
    def vec3i(self) -> tuple[int, int, int]:
        """ Read three 32 bit integers, and return them as a 3-point vector as a tuple. Advances the position forward by 12 bytes. """
        return self.read("3i")
